...
(function () {
  ...
  window.QUESTION_DATA.vocabulary = [
    ...
    w("005", "kjøreskole", "автошкола", "Jeg går på kjøreskole i Oslo.", "Я хожу в автошколу в Осло.", "Основное"),
    w("006", "kjørelærer", "инструктор по вождению", "Kjørelæreren min er veldig tålmodig.", "Мой инструктор очень терпеливый.", "Основное"),
