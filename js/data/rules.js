...
(function () {
  ...
  window.QUESTION_DATA.rules = [
    ...
    q("052", "Kan du krysse en heltrukket midtlinje for å kjøre forbi en syklist eller moped?",
      ...
      [["Nei, sperrelinje må ikke krysses; vent til linjen blir stiplet eller sikten tillater forbikjøring på egen side", "Нет, сплошную (sperrelinje) пересекать нельзя; жди, пока линия станет прерывистой или обгон будет возможен в своей полосе"], ["Ja, hvis sikten er god og det ikke er farlig", "Да, если хороший обзор и это не опасно"], ["Ja, men bare for syklister, ikke for moped", "Да, но только ради велосипедиста, не мопеда"], ["Bare hvis syklisten gir tegn om at det er greit", "Только если велосипедист сам разрешит жестом"]],
