...
(function () {
  ...
  window.QUESTION_DATA.rules = [
    ...
    q("059", "Du får motorstopp på en landevei utenfor tettbygd strøk og må gå ut av bilen. Hva er du pålagt å gjøre?",
      ...
      [["Ta på refleksvest før du går ut av bilen", "Надеть светоотражающий жилет перед тем как выйти из машины"], ["Det holder å slå på nødblink, refleksvest er bare anbefalt", "Достаточно включить аварийку, жилет — это только рекомендация", "Nødblink er riktig, men refleksvest er pålagt, ikke bare anbefalt, når du går ut av bilen ved nødstans langs veg.", "Аварийку включить правильно, но жилет обязателен, а не просто желателен, когда выходишь из машины при вынужденной остановке у дороги."], ["Refleksvest trengs bare om natten", "Жилет нужен только ночью", "Kravet gjelder uansett tid på døgnet når du går utenfor bilen ved nødstans langs veg.", "Требование действует в любое время суток, когда ты выходишь из машины при вынужденной остановке у дороги."], ["Bare føreren trenger refleksvest, passasjerer slipper", "Жилет нужен только водителю, пассажирам — нет", "Alle som går ut av bilen og oppholder seg på eller ved vegen skal bruke refleksvest, ikke bare føreren.", "Жилет нужен всем, кто выходит из машины и находится на дороге или рядом с ней, а не только водителю."]],
      "Forskrift om bruk av kjøretøy § 1-6: refleksvest skal brukes når en person beveger seg utenfor kjøretøyet ved nødstans langs veg. Det gjelder føreren og passasjerene, både i og utenfor tettbygd strøk.",
      "Forskrift om bruk av kjøretøy § 1-6: жилет надевает каждый, кто выходит из машины при вынужденной остановке у дороги, — и водитель, и пассажиры, в населённом пункте и за его пределами.",
